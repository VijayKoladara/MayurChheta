...
else
{
    ...
    {
        $get_id = $_GET['edit_upcoming_image'];

        $find_records = "select * from upcoming_category_images where id='$get_id'";
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa a-money fa-w"></i> Update Upcoming Category Images
                </h3>
            </div>
...
if(isset($_POST['submit']))
{
   ...
   }else
   {
       ...
       $query = "update upcoming_category_images SET category_name='$category_name',post_name='$post_name',image_thumb='$update_filename',status='$category_status' WHERE id='$get_id'";
       ...
       if($run_query)
       {
           ...
           echo "<script> alert('Upcoming Category Image Updated Successfully!') </script>";
