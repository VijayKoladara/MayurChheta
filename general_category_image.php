                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                            ...
                            <select name="category_name" id="" class="form-control">
                                ...
                                <?php
                                    $get_p_cats = "select * from general_category";
                ...
                <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <?php
                                $i=0;
                                $get_product = "select * from general_category_images";
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <a href="index.php?edit_general_cat_image=<?php echo $category_id; ?>">
                                            <i class="fa fa-pencil fa-2x"></i> 
                                            </a>
                                        </td>
                                        <td>
                                            <a href="index.php?delete_general_cat_image=<?php echo $category_id; ?>">
...
if(isset($_POST['submit']))
{
    ...
    $inset_products = "insert into general_category_images(category_name,post_name,image_thumb,status) values('$category_name','$post_name','$image_thumb','$category_status')";

    $run_product = mysqli_query($con,$inset_products);

    if($run_product)
    {
        echo "<script> alert('General Category Image Inserted!')</script>";
