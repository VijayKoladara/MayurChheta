...
else
{
    ...
    {
        $get_id = $_GET['edit_general_cat_image'];

        $find_records = "select * from general_category_images where id='$get_id'";
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa a-money fa-w"></i> Update General Category Images
                </h3>
            </div>
            ...
            <div class="panel-body">
                <form action="" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="submit" value="Update General Category Images" name="submit"
...
if(isset($_POST['submit']))
{
   ...
   }else
   {
       ...
       $query = "update general_category_images SET category_name='$category_name',post_name='$post_name',image_thumb='$update_filename',status='$category_status' WHERE id='$get_id'";
       ...
       if($run_query)
       {
           ...
           echo "<script> alert('General Category Image Updated Successfully!') </script>";
