            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <i class="fa a-money fa-w"></i> Insert Category Images
                    </h3>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                            ...
                            <select name="category_name" id="" class="form-control">
                                ...
                                <?php
                                    $get_p_cats = "select * from business_category";
                        ...
                        <div class="form-group">
                            <input type="submit" value="Insert Category Images" name="submit"
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">
                        <i class="fa a-money fa-w"></i> View Categories
                    </h3>
                </div>
                ...
                <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <?php
                                $i=0;
                                $get_product = "select * from business_category_images";
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <a href="index.php?edit_business_cat_image=<?php echo $category_id; ?>">
                                            <i class="fa fa-pencil fa-2x"></i> 
                                            </a>
                                        </td>
                                        <td>
                                            <a href="index.php?delete_business_cat_image=<?php echo $category_id; ?>">
...
if(isset($_POST['submit']))
{
    ...
    $inset_products = "insert into business_category_images(category_name,post_name,image_thumb,status) values('$category_name','$post_name','$image_thumb','$category_status')";

    $run_product = mysqli_query($con,$inset_products);

    if($run_product)
    {
        echo "<script> alert('Business Category Image Inserted!')</script>";
